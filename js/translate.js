document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      "aboutTechtrum_title": "Techtrum Consult is a specialized consulting firm",
      "aboutTechtrum_desc1": "Offering advisory services in modern technologies and telecommunications within the business sector.",
    ...
    ar: {
      ...
      "subtitle2": "الرؤية",
      "title2": "أن نكون الخيار الأول للمؤسسات",
      ...
      "description3": "الريادة في الأفكار والحلول المبتكرة التي تعزز كفاءة الأعمال وتزيد الإنتاجية لتحقيق الاستدامة على المستويات البيئية والاجتماعية والحوكمة.",
      "join3": "انضم الآن",
      "readmore3": "اقرأ المزيد",
      "aboutTechtrum_subtitle": "عن تكتروم",
      "aboutTechtrum_title": "تيكتروم كونسلت هي شركة استشارية متخصصة",
      "aboutTechtrum_desc1": "تقدم خدمات استشارية في التقنيات الحديثة وخدمات الاتصالات في المجال التجاري.",
